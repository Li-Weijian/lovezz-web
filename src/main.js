...
import { Grid, GridItem, NavBar, Icon , Swipe, SwipeItem, Image, Field ,Button, CellGroup, Toast, ActionSheet, List,Cell,
  Tag ,Dialog,Popup,Circle,Row, Col, Tabbar, TabbarItem,Lazyload, Uploader,Rate, Skeleton, Divider,Tab,Tabs, RadioGroup, Radio} from 'vant';
...
Vue.use(Grid).use(GridItem).use(NavBar).use(Icon).use(Swipe).use(SwipeItem).use(Image)
  ...
  .use(Lazyload).use(Uploader).use(Rate).use(Skeleton).use(Divider).use(Tab).use(Tabs).use(RadioGroup)
  .use(Radio);
